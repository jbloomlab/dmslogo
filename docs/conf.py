...
versionfile = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../dmslogo/__init__.py")
)
...
html_theme_options = {
    "logo": "BloomLogo.jpg",
    "logo_name": "true",
    "description": "Sequence logos for deep mutational scanning",
    "github_button": "true",
...
latex_documents = [
    (master_doc, "dmslogo.tex", "dmslogo Documentation", "the Bloom lab", "manual"),
]
...
man_pages = [(master_doc, "dmslogo", "dmslogo Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "dmslogo",
        "dmslogo Documentation",
        author,
        "dmslogo",
        "Logo plots for deep mutational scanning data.",
        "Miscellaneous",
    ),
]
