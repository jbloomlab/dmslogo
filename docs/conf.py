...
versionfile = os.path.abspath(os.path.join(
        os.path.dirname(__file__), '../dmslogo/__init__.py'))
...
latex_documents = [
    (master_doc, 'dmslogo.tex', u'dmslogo Documentation',
...
man_pages = [
    (master_doc, 'dmslogo', u'dmslogo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dmslogo', u'dmslogo Documentation',
     author, 'dmslogo', 'Logo plots for deep mutational scanning data.',
     'Miscellaneous'),
    ]
