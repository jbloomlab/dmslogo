...
------------------------------
The docs are hosted on `GitHub pages`_ at https://jbloomlab.github.io/dmslogo
...
First, clone the repo into ``_build/html/``::
    ...
    mkdir _build
    git clone https://github.com/jbloomlab/dmslogo _build/html
...
After a few minutes, your docs should now show up at https://jbloomlab.github.io/dmslogo
